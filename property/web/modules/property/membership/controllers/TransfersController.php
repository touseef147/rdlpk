...
/**
 * TransfersController implements the CRUD actions for Propertymemberships model.
 */
class TransfersController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "transfers", "property/membership");
        ...
        if(count(Yii::$app->request->queryParams)==1)
        {
            ...
            if($res==NULL)
            {
                $dataProvider = $searchModel->searchtransfers(Yii::$app->request->queryParams);
            ...
            {
                $dataProvider = $searchModel->searchtransfers($res);
    ...
    public function actionCreate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return [
                    "saved",
                    Yii::$app->urlManager->baseUrl."/index.php?r=property/membership/transfers/index",
                    "Record Saved",
...
//            return "Failed to remove record";
    ...
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"property/membership/transfers/index"]);
