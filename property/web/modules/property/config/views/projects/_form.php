        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="col-xs-3">
                    ...
                    <?= $form->field($model, 'project_image')->textInput(['maxlength' => true]) ?></div>
                <div class="col-xs-3">

                    <?= $form->field($model, 'project_map')->textInput(['maxlength' => true]) ?></div>
                <div class="col-xs-3">

                    <?= $form->field($model, 'land_map')->textInput(['maxlength' => true]) ?></div>
                <div class="col-xs-3">

                    <?= $form->field($model, 'report_title_line1')->textInput(['maxlength' => true]) ?></div>
                <div class="col-xs-3">

                    <?= $form->field($model, 'report_title_line2')->textInput(['maxlength' => true]) ?></div>
                <div class="col-xs-3">
                ...
                <div class="col-xs-3">
                    ...
                    <?= $form->field($model, 'modify_date')->textInput(['class' => 'date-picker']) ?>
