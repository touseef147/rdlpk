                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            <td class="center">      </td>
                                                <td align="left"> 
                                                  <?= app\components\Detaillistaction::widget(["action" => "property/config/files/update", "id" => $row->id, "text" => $row->project->project_name, "rights" => $myrights]) ?>
                                            ...
                                            <td align="left"><?php echo $row->status; ?>      </td>
                                             <td class="center">
                                                ...
                                                <a data-original-title="Delete" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/files/delete&id=<?php echo $row->id; ?>" class="tooltip-error deletelink" data-rel="tooltip" title="">
                                                        <span class="red">
