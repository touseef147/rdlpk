...
class PropertyapplicationController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->register($modelmember, (isset($data["category"]) ? $data["category"] : null))) {
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->edit($modelmember, $modelnewnominee, $data["category"], $modelphoto, $modelcnic, $data["nominee"])) {
                \Yii::$app->response->format = 'json';
        ...
        $model->application_date = \Yii::$app->formatter->asDate($model->application_date, 'php:d-m-Y');
        $model->application_date = \Yii::$app->formatter->asDate($model->plan_start_date, 'php:d-m-Y');
