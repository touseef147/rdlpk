...
/**
 * GroupsController implements the CRUD actions for Membersdealergroups model.
 */
class GroupsController extends Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return [
                "saved",
                Yii::$app->urlManager->baseUrl . "/index.php?r=members/dealers/groups/index",
                "Record Saved",
...
//            return "Failed to remove record";
    ...
    public function actionSidebarsummary() {
        $res = \app\models\Model::checksavedinfo(["r" => "members/dealers/groups/index"]);
        $myrights = \app\models\Model::getRights("index", "groups", "members/dealers");
