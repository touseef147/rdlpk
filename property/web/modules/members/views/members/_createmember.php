...
<div class="padding-8" style="padding: 8px 8px;">
    <h3 class="row header smaller lighter blue">
        ...
        <span class=" pull-right smaller-60">
    ...
    <div class="row">
        ...
        <div class="col-xs-3">
            <?= Html::activeLabel($model, 'image', ['class' => 'control-label']) ?>
            <?= Html::activeInput('file', $model, 'image', ['class' => 'col-xs-12']) ?>
            <?= Html::error($model, 'image', ['class' => 'help-block']) ?>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="form-group pull-right" style="padding-top: 10px;">
                <button type="button" class="btn btn-primary btn-white btn-round btnsubmitandcontsubpage" data-url="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/createmember">
                    Update
