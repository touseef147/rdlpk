 ...
 */
                                                        ...
                                                        $booking = new \app\models\application\Interestbooking();
                                                        ?>
                                                    <tr>
                                                        <td class="">
                                                            <?php
                                                        ...
                                                        <td class="hidden-480">
                                                            <?php 
															 echo Html::dropDownList('Interestbooking['.$id.'][project_id]',null,
                                                                            ArrayHelper::map(\app\models\application\Projects::find()->joinWith("permissions")->orderBy("projects.project_name")->where(['project_permissions.user_id'=>$_SESSION["user_array"]["id"]])->all(), 'id', 'project_name'),           // Flat array ('id'=>'label')
                                                                                ['prompt' => '---',
                                                                                    //'name'=>'Interestbooking['.$bcount.'][center_id]'
                                                                                    ]    // options
                                                                    );
