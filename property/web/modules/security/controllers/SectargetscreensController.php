...
use app\models\application\SectargetscreensSearch;
...
/**
 * SectargetscreensController implements the CRUD actions for Sectargetscreens model.
 */
class SectargetscreensController extends Controller
{
    ...
    /**
     * Lists all Sectargetscreens models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "sectargetscreens", "security");
        
        $searchModel = new SectargetscreensSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Sectargetscreens model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Sectargetscreens model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Sectargetscreens model.
     * @param string $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Sectargetscreens model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Sectargetscreens();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Sectargetscreens model.
    ...
    /**
     * Deletes an existing Sectargetscreens model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Sectargetscreens model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"security/sectargetscreens/index"]);
        
        $searchModel=$searchModel= new SectargetscreensSearch();
    ...
    /**
     * Finds the Sectargetscreens model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return Sectargetscreens the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Sectargetscreens::findOne($id)) !== null) {
            return $model;
        } else {
