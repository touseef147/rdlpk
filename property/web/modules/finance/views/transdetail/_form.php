...
<div class="fmstransdetail-form">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                    ...
                    <li >
                                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/transdetail/index" class="ajaxlink">Summary</a>
                    </li>
    ...
    <div class="page-content">
            ...
            <div class="row">
                    <div class="col-xs-12">
                        <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/transdetail/sidebarinput">
