                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            <td class="center">      </td>
                                            <td align="left">                            <?php if (array_key_exists("finance/voucherplotdetail/update", $myrights)) {
                                        ?>                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/voucherplotdetail/update&id=<?php echo $row->voucher_plot_detail_id; ?>" class="ajaxlink"><?php echo $row->voucher_id; ?></a>
                                                <?php
                                                } else {
                                                    echo $row->voucher_id;
                                                }
                                            ...
                                            <td align="left"><?php echo $row->membership_id; ?>      </td>
                                            <td align="left"><?php echo $row->serial_no; ?>      </td>
