...
<div class="fmsvoucherplotdetail-search">
    ...
    'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=finance/voucherplotdetail/index",
    'method' => 'GET',
    'class' => 'frmsearch',
    'id' => 'frmsearch',
    ]);
            ...
            <td>
                <table>
                    ...
                    ?>                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/voucherplotdetail/create" class="ajaxlink">
                    ...
                    <?php                    }
                    if (array_key_exists("finance/voucherplotdetail/printsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/voucherplotdetail/printsummary" class="reportlink">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary
                            </a>
                        </td>
                    ...
                    <?php                    }
                    if (array_key_exists("finance/voucherplotdetail/pdfsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/voucherplotdetail/pdfsummary">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary (pdf)
                            </a>
                        </td>
