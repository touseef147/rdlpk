                                                        ...
                                                        <td align="left">                            
                                                            ...
                                                            if ($row->entry_status == 1) {
                                                                if (array_key_exists("finance/fmsvoucher/update", $myrights)) {
                                                                    ?>                                                                
                                                                    <a data-toggle="tooltip" title="Click to update record." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/update&id=<?php echo $row->voucher_id; ?>"  class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                    <?php
                                                                } else {
