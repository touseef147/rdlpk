...
use app\models\application\FmsacccategoriesSearch;
...
/**
 * AcccategoriesController implements the CRUD actions for Fmsacccategories model.
 */
class AcccategoriesController extends Controller
{
    ...
    /**
     * Lists all Fmsacccategories models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "AcccategoriesController", "modulename");
        
        $searchModel = new FmsacccategoriesSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Fmsacccategories model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Fmsacccategories model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Fmsacccategories model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Fmsacccategories model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Fmsacccategories();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Fmsacccategories model.
    ...
    /**
     * Deletes an existing Fmsacccategories model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Fmsacccategories model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/AcccategoriesController/index"]);
    ...
    /**
     * Finds the Fmsacccategories model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Fmsacccategories the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Fmsacccategories::findOne($id)) !== null) {
            return $model;
        } else {
