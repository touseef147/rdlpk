...
use app\models\application\FmsaccountsSearch;
...
/**
 * AccountsController implements the CRUD actions for Fmsaccounts model.
 */
class AccountsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "AccountsController", "modulename");
        
        $searchModel = new FmsaccountsSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Fmsaccounts model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Fmsaccounts model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Fmsaccounts model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Fmsaccounts model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Fmsaccounts();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Fmsaccounts model.
    ...
    /**
     * Deletes an existing Fmsaccounts model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Fmsaccounts model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/AccountsController/index"]);
    ...
    /**
     * Finds the Fmsaccounts model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Fmsaccounts the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Fmsaccounts::findOne($id)) !== null) {
            return $model;
        } else {
