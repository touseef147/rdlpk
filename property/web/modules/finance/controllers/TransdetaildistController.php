...
/**
 * TransdetaildistController implements the CRUD actions for Fmstransdetaildist model.
 */
class TransdetaildistController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "TransdetaildistController", "modulename");
...
//            return "Failed to remove record";
    ...
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/TransdetaildistController/index"]);
