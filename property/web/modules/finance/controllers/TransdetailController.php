...
use app\models\application\FmstransdetailSearch;
...
/**
 * TransdetailController implements the CRUD actions for Fmstransdetail model.
 */
class TransdetailController extends Controller
{
    ...
    /**
     * Lists all Fmstransdetail models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "TransdetailController", "modulename");
        
        $searchModel = new FmstransdetailSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Fmstransdetail model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Fmstransdetail model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Fmstransdetail model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Fmstransdetail model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Fmstransdetail();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Fmstransdetail model.
    ...
    /**
     * Deletes an existing Fmstransdetail model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Fmstransdetail model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/TransdetailController/index"]);
    ...
    /**
     * Finds the Fmstransdetail model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Fmstransdetail the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Fmstransdetail::findOne($id)) !== null) {
            return $model;
        } else {
