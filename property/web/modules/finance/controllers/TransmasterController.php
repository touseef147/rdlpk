...
use app\models\application\FmstransmasterSearch;
...
/**
 * TransmasterController implements the CRUD actions for Fmstransmaster model.
 */
class TransmasterController extends Controller
{
    ...
    /**
     * Lists all Fmstransmaster models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "TransmasterController", "modulename");
        
        $searchModel = new FmstransmasterSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Fmstransmaster model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Fmstransmaster model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Fmstransmaster model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Fmstransmaster model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Fmstransmaster();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Fmstransmaster model.
    ...
    /**
     * Deletes an existing Fmstransmaster model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Fmstransmaster model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/transmasterController/index"]);
    ...
    /**
     * Finds the Fmstransmaster model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Fmstransmaster the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Fmstransmaster::findOne($id)) !== null) {
            return $model;
        } else {
