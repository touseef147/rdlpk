...
class Installpayment extends \yii\db\ActiveRecord {
    ...
    public static function generatePlanFromApplication(&$app) {
        ...
        if ($plan != NULL) {
            $app->addError('application_no', 'Installment Plan already exist.');
            return FALSE;
        }
    ...
    public static function paymultipleinstallments(&$installpayments, &$valid, $plotid, $parentid) {
