...
/**
 * This is the model class for table "installpayment_comments".
 *
 * @property string $comment_id
 * @property integer $installpayment_id
 ...
 */
class Installpaymentcomments extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'installpayment_comments';
    }
    ...
    {
        return [
            [['installpayment_id', 'comments', 'user_id', 'date', 'generated_by', 'comment_type', 'ip_address'], 'required'],
            [['installpayment_id', 'user_id', 'generated_by', 'comment_type', 'parent_id'], 'integer'],
            [['date', 'location'], 'safe'],
...
//            [['ip_address'], 'string', 'max' => 10]
    ...
    public function attributeLabels()
    {
        return [
            ...
            'installpayment_id' => 'Installpayment ID',
            'comments' => 'Comments',
            'user_id' => 'User ID',
            'date' => 'Date',
    ...
    {
        return $this->hasOne(Installpaymentcomments::className(), ['parent_id' => 'comment_id']);
    }
    ...
    public function getInstallment() {
        return $this->hasOne(Installpaymentcomments::className(), ['id' => 'installpayment_id']);
    }
    ...
    public static function updatesystemcomments($comment, $commenttype, $parentid) {
        ...
        $history = new Installpaymentcomments();
        ...
        $history->installpayment_id = $parentid;
