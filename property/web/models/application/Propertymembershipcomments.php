...
/**
 * This is the model class for table "property_membership_comments".
 *
 ...
 */
class Propertymembershipcomments extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'property_membership_comments';
    }
    ...
    {
        return [
            [['ms_id', 'comments', 'user_id', 'date', 'generated_by', 'comment_type', 'ip_address'], 'required'],
            [['ms_id', 'user_id', 'generated_by', 'comment_type', 'parent_id'], 'integer'],
            [['date', 'location'], 'safe'],
...
//            [['ip_address'], 'string', 'max' => 10]
    ...
    {
        return $this->hasOne(Propertymembershipcomments::className(), ['parent_id' => 'comment_id']);
    }
    ...
    public static function updatesystemcomments($comment, $commenttype, $parentid) {
        ...
        $history = new Propertymembershipcomments();
