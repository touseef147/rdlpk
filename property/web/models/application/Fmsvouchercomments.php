...
/**
 * This is the model class for table "fms_voucher_comments".
 *
 ...
 */
class Fmsvouchercomments extends \yii\db\ActiveRecord {

    /**
     * @inheritdoc
     */
    public static function tableName() {
        return 'fms_voucher_comments';
    }
    ...
    public function rules() {
        return [
            [['voucher_id', 'comments', 'user_id', 'date', 'generated_by', 'comment_type', 'ip_address'], 'required'],
            [['voucher_id', 'user_id', 'generated_by', 'comment_type', 'parent_id'], 'integer'],
            [['date', 'location'], 'safe'],
...
//            [['ip_address'], 'string', 'max' => 10]
    ...
    public function getParent() {
        return $this->hasOne(Fmsvouchercomments::className(), ['parent_id' => 'comment_id']);
    }
    ...
    public static function updatesystemcomments($comment, $commenttype, $parentid) {
        ...
        $history = new Fmsvouchercomments();
