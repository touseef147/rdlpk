    ...
    <script type="text/javascript">
      function drawVisualization() {
        ...
        new google.visualization.ColumnChart(document.getElementById('visualization')).
            draw(data,
                 {title:"",
                  width:data.getNumberOfRows() * 40, height:data.getNumberOfColumns() * 60,
                  vAxis: {title: "Strenght"}, hAxis: {title: "Days"}}
            );
      }
      ...
      <td style="padding:0 10 0 10; "><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="40" colspan="4" valign="middle" class="BoledText" style="border-left:thin; border-left-style:solid; border-top:thin; border-top-style:solid; border-right:thin; border-right-style:solid"><div id="visualization"></div></td>
                </tr>
            </table></td>
          </tr>
      </table></td>
