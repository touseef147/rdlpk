...
//            return $this->goBack();
        ...
        if (isset(Yii::$app->user) && Yii::$app->user != null && isset(Yii::$app->user->id) && Yii::$app->user->id != null) {
            print_r(Yii::$app->user);
            return;
            //$this->redirect("index.php?r=dashboard/");
        }
...
//        }
    ...
    public function actionMemlogout() {
        Yii::$app->member->logout();

        return $this->redirect("index.php?r=members/portal/default/index");
    }
    ...
    public function actionTestemail() {
                \app\models\Model::sendmail('inam@hrlpk.com', 'test', 'body');
                return $this->render('about');
    }
