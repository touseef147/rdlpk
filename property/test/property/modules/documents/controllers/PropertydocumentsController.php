...
use app\models\application\PropertydocumentsSearch;
...
class PropertydocumentsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "PropertydocumentsController", "modulename");
        
        $searchModel = new PropertydocumentsSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Propertydocuments model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Propertydocuments model.
     * @return mixed
     */
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Propertydocuments model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/PropertydocumentsController/index"]);
