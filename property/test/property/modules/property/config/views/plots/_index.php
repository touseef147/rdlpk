                    ...
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar">
                            ...
                            <div class="btn btn-xs btn-primary btn-white btn-round dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-info">
                                    <li>
                                        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/plots/pdfsummary&allpages=no&resulttype=excel">Current Page</a>
                                    </li>

                                    <li>
                                        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/plots/pdfsummary&resulttype=excel">All Pages</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn btn-xs btn-primary btn-white btn-round dropdown">
                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="detail-col  <?php echo $colnameclass; ?>"><?php echo $dataProvider->sort->link('plot_no') ?>      </th>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            ...
                                            <td align="left"><?php echo $row->plot_no; ?>      </td>
