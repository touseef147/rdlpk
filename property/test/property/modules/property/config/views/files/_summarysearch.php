...
<div class="files-search">
    ...
    $form = ActiveForm::begin([
                'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=property/config/files/",
                'method' => 'GET',
                'class' => 'frmsearch',
                'id' => 'frmsearch',
    ]);
    ...
    <table width="100%" style="margin-top:10px;" class="sidebar_links_title_table">
        ...
        <tr style="">
            ...
            <td>
                <table>
                    <?php
                    if (array_key_exists("property/config/files/create", $myrights)) {
                        ?>
                        <tr>
                            <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                            </td>
                            <td>
                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/files/create" class="ajaxlink">
                    ...
                    ?>
                    <?php
                    if (array_key_exists("property/config/files/printsummary", $myrights)) {
                        ?>
                        <tr>
                            <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                            </td>
                            <td>
                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/files/printsummary" class="reportlink">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Print Summary
                                </a>
                            </td>
                    ...
                    ?>
                    <?php
                    if (array_key_exists("property/config/files/pdfsummary", $myrights)) {
                        ?>
                        <tr>
                            <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                            </td>
                            <td>
                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/config/files/pdfsummary">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Print Summary (pdf)
                                </a>
                            </td>
        ...
        <tr style="">
            ...
            <td>
                ...
                <?= $form->field($searchModel, 'plotno')->textInput()->label('MS No.') ?>
                <?=
        ...
        <tr style="">
            ...
            <td>
                ...
                <?=
                $form->field($searchModel, 'msstatus')->dropDownList(
                        // Flat array ('id'=>'label')
