...
class PropertyapplicationController extends Controller {
    ...
    public function beforeAction($action) {
        ...
        if($action->actionMethod == "actionNewbooking"){
...
//$modelmember,
    ...
    public function actionNewbooking() {
        ...
        $model = new Propertyapplication();
        $modelmember = \app\models\application\Members::find()->where(['id' => Yii::$app->member->id]);
        $modelpcateg = \app\models\application\Categories::find()->all();
        $modelinstallmentplan = null;
...
//$modelmember,
        ...
        $request = Yii::$app->request;
        if ($request->isAjax) {
            return $this->renderPartial('_newbooking', [
                        'model' => $model,
                        'modelmember' => $modelmember,
                        'modelpcateg' => $modelpcateg,
                        'modelinstallmentplan' => $modelinstallmentplan,
