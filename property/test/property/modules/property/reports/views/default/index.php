<div class="general-default-index">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                    ...
                    <li class="active">Propertyreports</li>
            </ul><!-- /.breadcrumb -->
    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="main-icons" style="height: 120px;">
                            <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=Propertyreports/controller/index">
