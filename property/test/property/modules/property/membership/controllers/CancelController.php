...
class CancelController extends Controller {
    ...
    public function actionIndex() {
        ...
        $myrights = \app\models\Model::getRights("index", "cancel", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                ...
                $dataProvider = $searchModel->searchcancelreq(Yii::$app->request->queryParams,11);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchcancelreq($res,11);
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($result) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/cancel/index",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
...
//            return "Failed to remove record";
    ...
    public function actionFinancever() {
        ...
        $request = Yii::$app->request;
        $myrights = \app\models\Model::getRights("financever", "cancel", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                $dataProvider = $searchModel->searchcancelreq(Yii::$app->request->queryParams,12);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchcancelreq($res,12);
    ...
    public function actionApproval() {
        ...
        $request = Yii::$app->request;
        $myrights = \app\models\Model::getRights("approval", "cancel", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                $dataProvider = $searchModel->searchcancelreq(Yii::$app->request->queryParams,13);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchcancelreq($res,13);
    ...
    public function actionFinanceverdetail($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($result) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/cancel/financever",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
    ...
    public function actionApprovaldetail($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->approve()) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/cancel/approval",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
    ...
    public function actionCount() {
        $model = \app\models\application\Propertymemberships::find()->innerJoinWith("plot")->andFilterWhere(['plots.activation_status' => 11])->select('plots.ms_id')->all();

        return count($model);
    }

    public function actionCountver() {
        $model = \app\models\application\Propertymemberships::find()->innerJoinWith("plot")->andFilterWhere(['plots.activation_status' => 12])->select('plots.ms_id')->all();

        return count($model);
    }

    public function actionCountapp() {
        $model = \app\models\application\Propertymemberships::find()->innerJoinWith("plot")->andFilterWhere(['plots.activation_status' => 13])->select('plots.ms_id')->all();
