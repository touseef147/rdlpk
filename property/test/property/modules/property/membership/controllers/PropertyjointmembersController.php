...
use app\models\application\PropertyjointmembersSearch;
...
/**
 * PropertyjointmembersController implements the CRUD actions for Propertyjointmembers model.
 */
class PropertyjointmembersController extends Controller
{
    ...
    /**
     * Lists all Propertyjointmembers models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "PropertyjointmembersController", "modulename");
        
        $searchModel = new PropertyjointmembersSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Propertyjointmembers model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Propertyjointmembers model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Propertyjointmembers model.
     * @param string $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Propertyjointmembers model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Propertyjointmembers();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Propertyjointmembers model.
    ...
    /**
     * Deletes an existing Propertyjointmembers model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Propertyjointmembers model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/PropertyjointmembersController/index"]);
    ...
    /**
     * Finds the Propertyjointmembers model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return Propertyjointmembers the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Propertyjointmembers::findOne($id)) !== null) {
            return $model;
        } else {
