...
class MergeController extends Controller {
    ...
    public function actionIndex() {
        ...
        $myrights = \app\models\Model::getRights("index", "merge", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                ...
                $dataProvider = $searchModel->searchmergereq(Yii::$app->request->queryParams,21);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchmergereq($res,21);
    ...
    public function actionCreaterequest($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($result) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/" . ($var == "forward" ? "index" : "update&id=" . $id ),
                    "Record Saved",
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($result) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/index",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
...
//            return "Failed to remove record";
    ...
    public function actionSidebarsummary() {
        $res = \app\models\Model::checksavedinfo(["r" => "property/memberships/merge/index"]);
        $myrights = \app\models\Model::getRights("index", "merge", "property/memberships");
    ...
    public function actionSidebarapprovalsearch() {
        $res = \app\models\Model::checksavedinfo(["r" => "property/memberships/merge/approval"]);
        $myrights = \app\models\Model::getRights("approval", "merge", "property/memberships");
    ...
    public function actionSidebarfinanceversearch() {
        $res = \app\models\Model::checksavedinfo(["r" => "property/memberships/merge/financever"]);
        $myrights = \app\models\Model::getRights("financever", "merge", "property/memberships");
    ...
    public function actionFinancever() {
        ...
        $request = Yii::$app->request;
        $myrights = \app\models\Model::getRights("financever", "merge", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                $dataProvider = $searchModel->searchmergereq(Yii::$app->request->queryParams,22);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchmergereq($res,22);
    ...
    public function actionApproval() {
        ...
        $request = Yii::$app->request;
        $myrights = \app\models\Model::getRights("approval", "merge", "property/membership");
        ...
        if (count(Yii::$app->request->queryParams) == 1) {
            ...
            if ($res == NULL) {
                $dataProvider = $searchModel->searchmergereq(Yii::$app->request->queryParams,23);

                $dataProvider->pagination->pageSize = $request->get("pagesize", 20);
                $dataProvider->pagination->page = $request->get("pageno", 0);
            } else {
                $dataProvider = $searchModel->searchmergereq($res,13);
    ...
    public function actionFinanceverdetail($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($result) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/financever",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
    ...
    public function actionApprovaldetail($id) {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->approve()) {
                ...
                return [
                    "saved",
                    Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/approval",
                    "Record Saved",
                    "Record saved successfully"
                ];
            }
    ...
    public function actionUpdatecomments() {
        ...
        if ($model->updaterecord()) {
            ...
            return [
                "saved",
                Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/comments&id=" . $data["comment_box_parent_id"],
                "Record Saved",
                "Record saved successfully"
            ];
        }
