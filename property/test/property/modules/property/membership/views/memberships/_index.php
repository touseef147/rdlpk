                                        ...
                                        <table id="simple-table" class="table  table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo "Dealer" //$dataProvider->sort->link('dealer_name')  ?>      </th>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <?php if ($updateallowed) { ?>
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/memberships/update&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->currentmembership->application->application_no; ?></a>
                                                                <?php
                                                            } else {
                                                        ...
                                                        <td>                            
                                                            <?php if ($updateallowed) { ?>
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/memberships/update&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->plot->completecode; ?></a>
                                                                <?php
                                                            } else {
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-info">
                                                                    ...
                                                                    if ($cancelallowed) {
                                                                        ...
                                                                        ?>
                                                                        <li>
                                                                            <a class="ajaxlink" data-toggle="tooltip" title="Click Cancel file."  href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/convert/createrequest&id=<?php echo $row->ms_id; ?>">Convert File</a>
                                                                        </li>
                                                                        <?php
                                                                        //}
                                                                    }
                                                                    ...
                                                                    if ($cancelallowed) {
                                                                        ...
                                                                        ?>
                                                                        <li>
                                                                            <a class="ajaxlink" data-toggle="tooltip" title="Click Cancel file."  href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/merge/createrequest&id=<?php echo $row->ms_id; ?>">Merge File</a>
                                                                        </li>
                                                                        <?php
                                                                        //}
                                                                    }
