...
//            ["link" => "property/membership/default/index", "title" => "Memberships Control Panel"],
            ["link" => "property/membership/cancel/financever", "title" => "Cancel Memberships"],
            ["link" => "", "title" => "Finance Verification"],
        ],
    ])
    ?>
    ...
    <div class="page-content">
        ...
        <?= \app\components\Pageheader::widget(["title" => "Finance Verification", "subtitle" => ""]) ?>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="widget-box widget-color-blue3" id="widget-box-7">
                                                ...
                                                <div class="widget-body">
                                                    <div class="widget-main">
                                                        <?php
                                                        echo $form->field($file, 'refund_amount')->textInput()->label('Refund Amount');
                                                        ?>
                                                        <?php
                                                        echo $form->field($file, 'activation_fin_remarks')->textarea()->label('Remarks');
                                                        ?>
                                                    </div>
                                                    <div class="widget-toolbox padding-8 clearfix">
                                                        <button class="btn btn-xs btn-danger pull-left btn-round multiplesubmitbuttons" type="submit" name="submit" value="hold">
                                                            <i class="ace-icon fa fa-times"></i>
                                                            <span class="bigger-110">Hold</span>
                                                        </button>

                                                        <button class="btn btn-xs btn-success pull-right btn-round multiplesubmitbuttons" type="submit" name="submit" value="submit">
                                ...
                                <div class="widget-main no-padding">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab">
                                            ...
                                            <li class=" childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotcharges&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/memberships/financeverdetail%26id=" . $model->ms_id; ?>&allowedit=no">
                                            ...
                                            <li class="active childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotinstallments&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/memberships/financeverdetail%26id=" . $model->ms_id; ?>&allowedit=no">
                                                    <i class="green ace-icon fa fa-home bigger-120"></i>
                                                    Installment Details
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content no-padding">
                                            <div class="tab-pane fade in active" id="contentdetail">
                                                ...
                                                $this->renderFile(
                                                    ...
                                                    'sourcepage' => Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/memberships/financeverdetail%26id=" . $model->ms_id,
                                                    'myrights' => array(), // $instpaymentrights,
                                                    'allowedit' => 'no',
                                                ]);
                                                ?>                                    
                                                <?php
