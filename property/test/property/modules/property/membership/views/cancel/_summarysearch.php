...
$this->title = 'Cancel Memberships';
?>

<div class="propertymemberships-search">
    <?php
    $form = ActiveForm::begin([
                'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/cancel/index",
                'method' => 'GET',
                'class' => 'frmsearch',
                'id' => 'frmsearch',
    ]);
    ...
    <table width="100%" style="margin-top:10px;" class="sidebar_links_title_table">
        ...
        <tr style="">
            ...
            <td>
                <?=
                $form->field($searchModel, 'activation_status')->dropDownList(
                        app\models\application\Plots::cancillationstatuslist(), // Flat array ('id'=>'label')
                        [
