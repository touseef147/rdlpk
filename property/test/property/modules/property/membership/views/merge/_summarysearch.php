...
$this->title = 'Merge Files';
?>

<div class="propertymemberships-search">
    <?php
    $form = ActiveForm::begin([
                'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/index",
                'method' => 'GET',
                'class' => 'frmsearch',
                'id' => 'frmsearch',
    ]);
        ...
        <tr style="">
            ...
            <td>
                ...
                $form->field($searchModel, 'activation_status')->dropDownList(
                        app\models\application\Plots::mergestatuslist(), // Flat array ('id'=>'label')
                        [
