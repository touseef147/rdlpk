...
if (array_key_exists("property/membership/merge/financever", $myrights)) {
    $tab2allowed = true;
}
                                        ...
                                        <table id="simple-table" class="table  table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($rows as $row) { ?>
                                                    <tr>
                                                        <td align="left">
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/merge/approvaldetail&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->currentmembership->application->application_no; ?></a>
                                                        </td>
                                                        <td align="left"><?php echo $row->completecode; ?>      </td>
                                                        <td align="right">                            
                                                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/merge/approvaldetail&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to Update." class="ajaxlink"><?php echo $row->plot->completecode; ?></a>
                                                        </td>
