                ...
                <div class="widget-box ui-sortable-handle" id="widget-box-1">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar">
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/create" class="ajaxlink" data-toggle="tooltip" title="Click to Add New record.">Add</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            ...
                                            <td align="left"><a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/update&id=<?php echo $row->id; ?>" class="ajaxlink" data-toggle="tooltip" title="Click to update record."><?php echo $row->name; ?></a></td>
                                            ...
                                            <td class="center">
                                                <a data-original-title="Edit" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/update&id=<?php echo $row->id;  ?>" class="tooltip-error ajaxlink" data-toggle="tooltip" title="Click to update record.">
                                                    <span class="blue">
                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                    </span>
                                                </a>
                                                <a data-original-title="Delete" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/delete&id=<?php echo $row->id; ?>" class="tooltip-error deletelink" data-toggle="tooltip" title="Click to Delete record.">
                                                    <span class="red">
