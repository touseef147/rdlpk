                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        foreach ($dataProvidercolumns as $row) {
                                            $arrcols[] = 0;
                                            ?>
                                            <th style="width:70px;"><?= $row["code"] ?>      </th>
                                            <?php
                                        }
                                        ?>
                                    </tr>
...
//$rows = $dataProvider->getModels(); 
                                    ...
                                    foreach ($dataProvider as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            foreach ($dataProvidercolumns as $rowd) {
                                                $colno++;
                                                $found = false;

                                                foreach ($dataProvidervalues as $rowv) {
                                                    if ($rowd["id"] == $rowv["property_size"] && $row["id"] == $rowv["dealer_id"]) {
                                                        $found = true;
                                                        ?>
                                                        <td class="right" style="text-align: right;"><?php echo (intval($rowv["no_of_applications"]) == 0 ? "" : number_format($rowv["no_of_applications"])); ?>
                                                        </td>
                                                        <?php
                                    ...
                                    <tr>
                                        ...
                                        foreach ($dataProvidercolumns as $rowd) {
                                            ...
                                            foreach ($dataProvidervalues as $rowv) {
                                                if ($rowd["id"] == $rowv["property_size"] && ($rowv["dealer_id"] == null || intval($rowv["dealer_id"]) == 0)) {
                                                    $found = true;
                                                    ?>
                                                    <td class="right" style="text-align: right;"><?php echo (intval($rowv["no_of_applications"]) == 0 ? "" : number_format($rowv["no_of_applications"])); ?>
                                                    </td>
                                    ...
                                    <tr class="footer">
                                        ...
                                        foreach ($dataProvidercolumns as $rowd) {
                                            $colno++;
                                            ?>
                                            <th class="right" style="text-align: right; background-color: #EEE;"><?php echo ($arrcols[$colno] == 0 ? "" : $arrcols[$colno]); ?>
                                            </th>
                                            <?php
                                        }
