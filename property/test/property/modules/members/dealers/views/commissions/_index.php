                        ...
                        <div class="widget-box ui-sortable-handle" id="widget-box-1">
                            <div class="widget-header widget-header-large">
                                    ...
                                    <div class="widget-toolbar">
                                                                    <?php                            if (array_key_exists("members/dealers/commissions/create", $myrights)) {
                                ?>                                        
                                        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/create" class="ajaxlink">Adjust</a>&nbsp;&nbsp;
                                        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/createw" class="ajaxlink">Withdraw</a>
                                <?php                            }
                            ?>                                        <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/sidebarsummary">
...
<?php      foreach ($rows as $row) { ?>
      <tr>
      <td class="center">      </td>
      <td align="right">                            <?php    if (array_key_exists("members/dealers/commissions/update", $myrights)) {
                            ?>                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/update&id=<?php echo $row->distribution_id; ?>" class="ajaxlink"><?php echo $row->transaction->serial_no; ?></a>
                            <?php                                                }
                                                else {
                                                        echo $row->transaction->serial_no;                                                 }
                            ?>                                                                    </td>

                                                                  <td align="left"><?php echo $row->distributed_to_type; ?>      </td>
                                            <td>                            
                                                <?php if (array_key_exists("members/dealers/commissions/update", $myrights)) { ?> 
                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/update&id=<?php echo $row->distribution_id; ?>" class="ajaxlink"><?php echo $row->transaction->transtypetitle; ?></a>
                                                <?php
                                                } else {
      ...
      <td class="center">
<?phpif (array_key_exists("members/dealers/commissions/update", $myrights)) {?>      <a data-original-title="Edit" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/update&id=<?php echo $row->distribution_id; ?>" class="tooltip-error ajaxlink" data-rel="tooltip" title="">
              <span class="blue">
                      <i class="ace-icon fa fa-pencil bigger-120"></i>
              </span>
      </a><?php}?>
<?phpif (array_key_exists("members/dealers/commissions/delete", $myrights)) {?>      <a data-original-title="Delete" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/commissions/delete&id=<?php echo $row->distribution_id; ?>" class="tooltip-error deletelink" data-rel="tooltip" title="">
              <span class="red">
