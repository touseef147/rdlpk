...
<div class="membersdealergroups-search">
    ...
    'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=members/dealers/groups/index",
    'method' => 'GET',
    'class' => 'frmsearch',
    'id' => 'frmsearch',
    ]);
            ...
            <td>
                <table>
                    ...
                    ?>                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/groups/create" class="ajaxlink">
                    ...
                    <?php                    }
                    if (array_key_exists("members/dealers/groups/printsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/groups/printsummary" class="reportlink">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary
                            </a>
                        </td>
                    ...
                    <?php                    }
                    if (array_key_exists("members/dealers/groups/pdfsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/groups/pdfsummary">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary (pdf)
                            </a>
                        </td>
