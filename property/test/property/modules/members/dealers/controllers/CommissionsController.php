...
/**
 * CommissionsController implements the CRUD actions for Fmstransdetaildist model.
 */
class CommissionsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "commissions", "members/dealers");
        ...
        if(count(Yii::$app->request->queryParams)==1)
        {
            ...
            if($res==NULL)
            {
                $dataProvider = $searchModel->searchcommissions(Yii::$app->request->queryParams);
            ...
            {
                $dataProvider = $searchModel->searchcommissions($res);
...
//            return "Failed to remove record";
    ...
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"modulename/CommissionsController/index"]);
