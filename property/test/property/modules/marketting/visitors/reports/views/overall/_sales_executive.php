<div class="widget-box widget-color-blue  no-border" id="widget-box-1">
    <div class="widget-header widget-header-medium"  style="background-color: #f5f5f5;">
        ...
        <div class="widget-toolbar">
            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/printsummary" class="reportlink orange2">
            ...
            <div class="widget-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/pdfsummary&pagesize=a4p">Portrait</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/pdfsummary&pagesize=a4l">Landscape</a>
                    </li>
                </ul>
            </div>
            &nbsp;|&nbsp;
            <div class="widget-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/chart&charttype=bar">Bar Chart</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/chart&charttype=line">Line Chart</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/overall/chart&charttype=pie">Pie Chart</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="widget-body">
        <div class="widget-main no-padding">
            <div class="scrollable-horizontal" data-size="1300">
            <table id="simple-table" class="table  table-bordered table-hover table-report">
                <thead>
                    <tr>
                        ...
                        <th colspan="<?php echo 1+ count($modelColumnsp); ?>" class="center">Property      </th>
                        <th colspan="<?php echo  1+ count($modelColumns); ?>" class="center">Followup      </th>
                    </tr>
                    <tr>
                        ...
                        <?php
                        if(isset($modelColumnsp ))
                        {
                        foreach ($modelColumnsp as $col) {
                            ?>
