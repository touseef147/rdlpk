...
<table style="width: 100%;">
    <tr>
        ...
        <td style="<?php echo ($mode == "entry" ? "" : "border-bottom: dotted" );  ?>">
            ...
            if($mode == "entry"){
                echo Html::textInput('Fmsvoucherplotdetail[' . $idx . '][receipt_no]', $tempval,['style'=> 'background-color:rgb(248, 248, 156);']);
            }else{
                echo $tempval;
            }
    ...
    <tr>
        <td style="text-align: right; width: 100px; padding-right: 5px; height: 25px;">Membership No.</td>
        ...
        <td style="border-bottom: dotted"><?= $model->plot->sizeCat->size ?></td>
        <td style="text-align: right; width: 100px; padding-right: 5px; height: 25px;">Type</td>
        <td style="border-bottom: dotted"><?= ""//$model->plot->propertytypetitle ?></td>
    </tr>
    <tr>
