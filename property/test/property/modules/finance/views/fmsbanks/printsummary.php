...
/* @var $searchModel app\modules\finance\models\FmsbanksSearch */
...
?>
  ...
  <thead>
      ...
      <th class="HeaderMiddle" style="border-bottom:thin solid">Bank title      </th>
...
<?php      foreach ($rows as $row) { ?>
      ...
      <td class="GridMiddleCell" align="left"><?php echo $row->bank_title; ?>      </td>
