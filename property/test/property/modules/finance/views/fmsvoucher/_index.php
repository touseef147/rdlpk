                    ...
                    <div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            if ($tab2allowed) {
                                ?>
                                <li>
                                    <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/centerverification">
                            ...
                            if ($tab3allowed) {
                                ?>
                                <li>
                                    <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/financeverification">
                                        <i class="green ace-icon fa fa-th bigger-120"></i>
                                        Verify
                                        <span class="badge badge-danger">---</span>
                                    </a>
                            ...
                            if ($tab4allowed) {
                                ?>
                                <!--                                <li>
                                                                    <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/financeapproval">
                                                                        <i class="green ace-icon fa fa-th bigger-120"></i>
                                                                        Approve
                                                                        <span class="badge badge-danger">---</span>
                                                                    </a>
                                ...
                                <div class="widget-header widget-header-large">
                                    ...
                                    <div class="widget-toolbar">
                                        <?php if (array_key_exists("finance/fmsvoucher/create", $myrights)) {
                                            ?>                                        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/findmember" data-toggle="tooltip" title="Click to Add record." class="ajaxlink">Add</a>
                                        <?php }
                                        ?>                                        <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/sidebarsummary">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($rows as $row) { ?>
                                                    <tr>
                                                            ...
                                                            if ($row->entry_status <= 1) {
                                                                if (array_key_exists("finance/fmsvoucher/update", $myrights)) {
                                                                    if ($row->entry_status == -2) {
                                                                        ?>                                                                
                                                                        <a data-toggle="tooltip" title="Click to update record." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/voucherplotdetail/updatereceipts&voucherid=<?php echo $row->voucher_id; ?>"  class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                        <?php
                                                                    } else if ($row->entry_status == -1) {
                                                                        ?>                                                                
                                                                        <a data-toggle="tooltip" title="Click to update record." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/updateinstallments&id=<?php echo $row->voucher_id; ?>"  class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                        <?php
                                                                    } elseif ($row->entry_status == 1) {
                                                                        ?>                                                                
                                                                        <a data-toggle="tooltip" title="Click to update record." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/updateinstallments&id=<?php echo $row->voucher_id; ?>"  class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                        <?php
                                                                    } else {
                                                                ...
                                                                if ($row->amount_type == 5) {
                                                                    ?>
                                                                    <a target="_blank" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/viewfundtransfer&id=<?php echo $row->voucher_id; ?>"><?php echo $row->showentrydate; ?></a>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <a target="_blank" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/view&id=<?php echo $row->voucher_id; ?>"><?php echo $row->showentrydate; ?></a>
                                                                    <?php
                                                                }
                                                            }
                                                            ?>                                                                    
                                                        ...
                                                        <td align="left"><?php echo ($row->person == null ? $row->person_name : $row->person->name); ?>      </td>
                                                        ...
                                                        <td class="center">
                                                            <?php if (array_key_exists("finance/fmsvoucher/update", $myrights)) { ?>      <a data-original-title="Edit" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/update&id=<?php echo $row->voucher_id; ?>" class="tooltip-error ajaxlink" data-rel="tooltip" title="">
                                                                    <span class="blue">
                                                                        <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                                    </span>
                                                                </a><?php } ?>
                                                            <?php if (array_key_exists("finance/fmsvoucher/delete", $myrights)) { ?>      <a data-original-title="Delete" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/delete&id=<?php echo $row->voucher_id; ?>" class="tooltip-error deletelink" data-rel="tooltip" title="">
                                                                    <span class="red">
