...
//$serial = $id + 1;
//print_r($model);
$receiptnolabel = (!isset($searchcolumn) || $searchcolumn == NULL || $searchcolumn == "member_id" ? "Receipt No." : "JV. No.");
?>
...
<table style="width: 100%;">
    <tr>
        ...
        <td style="width:150px; <?php echo ($mode == "entry" ? "" : "border-bottom: dotted" );  ?>">
            ...
            $tempval = (isset($receipt) && $receipt != NULL ? ($receiptnolabel == "Receipt No." ?  $receipt->receipt_no : $receipt->jv_no) : NULL);
