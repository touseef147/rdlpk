...
//echo $sql;
    ...
    //for multiple receivers comma seperated list will be used.
    public static function sendsms($receiver, $message) {
        $username = "naval721"; ///Your Username
        $password = "654321"; ///Your Password
        $mobile = $receiver; ///Recepient Mobile Number
        $sender = "Naval Anch";
        //$message = $message;
...
////sending sms
        ...
        $url = "http://sendpk.com/api/sms.php?username=naval721&password=654321";
        $ch = curl_init();
        ...
        /* Print Responce */
        return $result;
        //OK ID:5d071042-828a-43ca-8130-ac68a06bf23c 
    }
