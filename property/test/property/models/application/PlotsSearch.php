...
class PlotsSearch extends Plots
{
    ...
    public function rules()
    {
        return [
            ...
            [['type', 'street_id', 'plot_detail_address', 'plot_size', 'size2', 'price', 'create_date', 'modify_date', 'com_res', 'sector', 'image', 'cstatus', 'status', 'fstatus', 'rstatus', 'bstatus', 'bid', 'atype', 'rownumber', 'plot_no'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'type','Plot'])
