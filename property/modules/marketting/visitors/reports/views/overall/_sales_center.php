<div class="widget-box widget-color-blue  no-border" id="widget-box-1">
    <div class="widget-header widget-header-medium"  style="background-color: #f5f5f5;">
        ...
        <div class="widget-toolbar">
            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/printsummary" class="reportlink orange2">
            ...
            <div class="widget-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/pdfsummary&pagesize=a4p">Portrait</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/pdfsummary&pagesize=a4l">Landscape</a>
                    </li>
                </ul>
            </div>
            &nbsp;|&nbsp;
            <div class="widget-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-right dropdown-light-blue dropdown-caret dropdown-closer">
                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/chart&charttype=bar">Bar Chart</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/chart&charttype=line">Line Chart</a>
                    </li>

                    <li>
                        <a class="reportlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=visits/visitorsreports/followup/chart&charttype=pie">Pie Chart</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <table id="simple-table" class="table  table-bordered table-hover table-report">
                <thead>
                    <tr>
                        ...
                        <th colspan="<?php echo 2+ count($modelColumns); ?>" class="center">Totals      </th>
                    </tr>
                    <tr>
