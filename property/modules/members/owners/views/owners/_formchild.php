...
<div class="members-form">
    ...
    <div class="page-content">
        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/owners/owners/update&id=<?php echo $model->parent_id ?>" class="ajaxlink pull-right"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
