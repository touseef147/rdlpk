...
<div class="members-index">
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers" class="ajaxlink">Dealers</a>
            </li>
                ...
                <div class="widget-box ui-sortable-handle" id="widget-box-1">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar">
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/dealers/create" class="ajaxlink">Add</a>
                            ...
                            <table id="simple-table" class="table  table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($rows as $row) { ?>
                                        <tr>
                                            <td class="center">      </td>
                                            <td align="left"><a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/dealers/dealers/update&id=<?php echo $row->id; ?>" class="ajaxlink"><?php echo $row->id; ?></a></td>
