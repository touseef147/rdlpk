...
<div class="members-index">
    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                    ...
                    <li>
                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members" class="ajaxlink">Members</a>
                    </li>
  ...
  <thead>
      ...
      <th class="detail-col  <?php echo $colnameclass; ?>"><?php echo $dataProvider->sort->link('id') ?>      </th>
      ...
      <th class="detail-col  <?php echo $colnameclass; ?>"><?php echo $dataProvider->sort->link('cnic') ?>      </th>
      <th class="detail-col  <?php echo $colnameclass; ?>"><?php echo $dataProvider->sort->link('image') ?>      </th>
      <th class="detail-col  <?php echo $colnameclass; ?>"><?php echo $dataProvider->sort->link('address') ?>      </th>
...
<?php      foreach ($rows as $row) { ?>
      <tr>
      <td class="center">      </td>
      <td align="left"><a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/update&id=<?php echo $row->id; ?>" class="ajaxlink"><?php echo $row->id; ?></a></td>
      ...
      <td align="left"><?php echo Html::img('/rdlpk/upload_pic/'.$row->image, ['height'=>'100'] ); ?>     </td>
      <td align="left"><?php echo $row->address; ?>      </td>
      <td align="left"><?php if($row->status==1) echo'Active'; else  echo'Inactive'; ?>      </td>
