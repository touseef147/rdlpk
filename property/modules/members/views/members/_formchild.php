...
<div class="members-form">
    ...
    <div class="page-content">
        <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=members/members/update&id=<?php echo $model->parent_id ?>" class="ajaxlink pull-right"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <?= $form->field($model, 'relation_with_member')->textInput(['maxlength' => true]) ?>
