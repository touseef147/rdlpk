...
<div class="latestnews-search">
    <form id="frmsearch" name="frmsearch" method="POST" action="index.php?r=general/latestnews/index">
            ...
            <td>
                <table>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=general/latestnews/create" class="ajaxlink">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=general/latestnews/printsummary" class="reportlink">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        Print Summary
                                </a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=general/latestnews/pdfsummary">
                                        <i class="menu-icon fa fa-caret-right"></i>
                                        Print Summary (pdf)
                                </a>
                        </td>
