...
/**
 * MembershipController implements the CRUD actions for Plots model.
 */
class MembershipController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "MembershipController", "modulename");
...
//            return "Failed to remove record";
    ...
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"property/membership/membership/index"]);
        $myrights = \app\models\Model::getRights("index", "membership", "property/membership");
        $searchModel = new PlotsSearch();
    ...
    public function actionFiledetails($id) {
        $model = \app\models\application\Plots::find()->where(['ms_id' => $id])->one();
