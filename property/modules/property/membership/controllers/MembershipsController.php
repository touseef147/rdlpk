...
//            }
    ...
    public function actionCount() {
        $model = \app\models\application\Propertymemberships::find()->innerJoinWith("currentmembership")->innerJoinWith("currentmembership.application")->andFilterWhere(['in', 'property_application.application_status', [1,10]])->andFilterWhere(['ms_status' => 1])->select('property_memberships.ms_id')->all();
