...
/* @var $model app\models\application\PlotsSearch */
...
<div class="plots-search">
    ...
    <?php // echo $form->field($model, 'ms_member_id') ?>

    <?php // echo $form->field($model, 'ms_creation_date') ?>

    <?php // echo $form->field($model, 'ms_modification_date') ?>

    <?php // echo $form->field($model, 'ms_status') ?>

    <?php // echo $form->field($model, 'ms_no') ?>
