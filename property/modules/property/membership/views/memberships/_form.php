                                ...
                                <div class="widget-main">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-2"><br />
                                            <button class="btn btn-xs btn-primary bottom-right multiplesubmitbuttons" type="submit" name="submit" value="update">
                                                <i class="ace-icon fa fa-save icon-on-right"></i>
                                                <span class="bigger-110">Assign MS. No.</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget-main no-padding">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab">
                                            ...
                                            <li class=" childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotcharges&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/memberships/update%26id=" . $model->ms_id; ?>">
                                            ...
                                            <li class="active childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotinstallments&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/memberships/update%26id=" . $model->ms_id; ?>">
                                                    <i class="green ace-icon fa fa-home bigger-120"></i>
                                                    Installment Details
                                                </a>
                                            </li>
