...
//            ["link" => "property/membership/default/index", "title" => "Memberships Control Panel"],
    ...
    <div class="page-content">
        ...
        <?= \app\components\Pageheader::widget(["title" => "Cancel Membership", "subtitle" => ""]) ?>
                                ...
                                <div class="widget-main padding-4">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-6">
                                            <div class="widget-box widget-color-blue3" id="widget-box-7">
                                                <div class="widget-header widget-header-small">
                                                    <h6 class="widget-title smaller">Cancellation Details</h6>
                                                </div>
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <div class="widget-toolbox padding-8 clearfix">
                                                        <button class="btn btn-xs btn-danger pull-right btn-round multiplesubmitbuttons" type="submit" name="submit" value="cancel">
