...
//            ["link" => "property/membership/default/index", "title" => "Memberships Control Panel"],
            ["link" => "property/membership/merge/index", "title" => "Summary"],
                    ...
                    <div class="col-xs-12">
                        <div class="widget-box widget-color-red3">
                            <div class="widget-header widget-header-medium">
                                <h6 class="widget-title bigger"><i class="icon-th-large"></i> Merge Request</h6>
                            </div>
                                ...
                                <div class="widget-main no-padding">
                                    <div class="tabbable">
                                        <ul class="nav nav-tabs" id="myTab">
                                            ...
                                            <li class=" childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotcharges&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/update%26id=" . $model->ms_id; ?>&allowedit=no">
                                            ...
                                            <li class="active childtabs">
                                                <a onclick="$('.childtabs').removeClass('active'); $(this).parent().addClass('active');" class="ajaxlink" data-targetdiv="contentdetail" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installpayment/plotinstallments&id=<?php echo $appform->file->id; ?>&sourcepage=<?php echo Yii::$app->urlManager->baseUrl . "/index.php?r=property/membership/merge/update%26id=" . $model->ms_id; ?>&allowedit=no">
                                                    <i class="green ace-icon fa fa-home bigger-120"></i>
                                                    Installment Details
                                                </a>
                                            </li>
