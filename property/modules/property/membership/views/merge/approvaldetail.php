...
//            ["link" => "property/membership/default/index", "title" => "Memberships Control Panel"],
            ["link" => "property/membership/merge/approval", "title" => "Merge Requests"],
            ["link" => "", "title" => "File Merge Approval"],
        ],
    ])
    ?>
    ...
    <div class="page-content">
        ...
        <?= \app\components\Pageheader::widget(["title" => "File Merge Approval", "subtitle" => ""]) ?>
