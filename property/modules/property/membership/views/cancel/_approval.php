...
if (array_key_exists("property/membership/cancel/index", $myrights)) {
    $tab1allowed = true;
}

if (array_key_exists("property/membership/cancel/financever", $myrights)) {
    $tab2allowed = true;
}
                    ...
                    <div class="tabbable">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            if ($tab1allowed) {
                                ?>
                                <li>
                                    <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/index">
                            ...
                            if ($tab2allowed) {
                                ?>
                                <li>
                                    <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/financever">
                            ...
                            if ($tab3allowed) {
                                ?>
                            <li class="active">
                                <a class="ajaxlink" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/approval">
                                    <i class="green ace-icon fa fa-th bigger-120"></i>
                                    Approval
                                    <span class="badge badge-danger">---</span>
                                </a>
                            ...
                            <div class="widget-box ui-sortable-handle" id="widget-box-1">
                                <div class="widget-header widget-header-large">
                                    ...
                                    <div class="widget-toolbar">
                                        ...
                                        <?php }
                                        ?>                                        
                                            <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/memberships/sidebarapprovalsearch">
                                        ...
                                        <table id="simple-table" class="table  table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($rows as $row) { ?>
                                                    <tr>
                                                        <td align="left">
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/approvaldetail&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->currentmembership->application->application_no; ?></a>
                                                        </td>
                                                        <td align="left"><?php echo $row->completecode; ?>      </td>
                                                        <td align="right">                            
                                                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/approvaldetail&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to Update." class="ajaxlink"><?php echo $row->plot->completecode; ?></a>
                                                        </td>
...
<!--                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-info">
                                                                    <li>
                                                                        <a class="ajaxlink" data-toggle="tooltip" title="Click for Payment." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/memberships/plotpaymentdetails&id=<?php echo $row->plot_id; ?>&parentpage=property/membership/memberships/approval">Payment Details</a>
                                                                    </li>
                                                                    ...
                                                                    if ($row->ms_status == 10 || $row->ms_status == 20) {
                                                                        ?>
                                                                        <li>
                                                                            <a class="ajaxlink" data-toggle="tooltip" title="Click for Transfer." href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/transfers/create&id=<?php echo $row->plot_id; ?>">Transfer</a>
                                                                        </li>
                                                                        <?php
                                                                    }
                                                                    ?>
