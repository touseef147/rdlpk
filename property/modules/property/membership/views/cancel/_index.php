...
if (array_key_exists("property/membership/cancel/update", $myrights)) {
    $updateallowed = true;
}
...
if (array_key_exists("property/membership/cancel/approval", $myrights)) {
    $tab3allowed = true;
}
...
<div class="propertymemberships-index">
    ...
    <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/sidebarsummary">
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <?php if ($updateallowed) { ?>
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/update&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->currentmembership->application->application_no; ?></a>
                                                                <?php
                                                            } else {
                                                        ...
                                                        <td>                            
                                                            <?php if ($updateallowed) { ?>
                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/update&id=<?php echo $row->ms_id; ?>" data-toggle="tooltip" title="Click to update record." class="ajaxlink"><?php echo $row->plot->completecode; ?></a>
                                                                <?php
                                                            } else {
...
//                                                                    if ($cancelallowed) {
                                                                        ...
                                                                        ?>
                                                                        <li>
                                                                            <a class="ajaxlink" data-toggle="tooltip" title="Click Cancel file."  href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=property/membership/cancel/createrequest&id=<?php echo $row->ms_id; ?>">Cancel Membership</a>
                                                                        </li>
                                                                        <?php
                                                                        //}
//                                                                    }
