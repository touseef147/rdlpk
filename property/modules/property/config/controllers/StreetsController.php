...
class StreetsController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return [
                "saved",
                Yii::$app->urlManager->baseUrl . "/index.php?r=property/config/streets/index",
                "Record Saved",
    ...
    public function actionDropdown($id = 0, $sectorid = 0, $projectid = 0) {
        $query = \app\models\application\Streets::find();
        ...
        if ($sectorid != 0) {
            $query = $query->andWhere(['sector_id' => $sectorid]);
        }
