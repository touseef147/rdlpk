...
use app\models\application\ProjectpermissionsSearch;
...
/**
 * ProjectpermissionsController implements the CRUD actions for Projectpermissions model.
 */
class ProjectpermissionsController extends Controller
{
    ...
    /**
     * Lists all Projectpermissions models.
     * @return mixed
     */
    public function actionIndex()
    {
        ...
        $myrights = \app\models\Model::getRights("index", "projectpermissions", "property/config");
        
        $searchModel = new ProjectpermissionsSearch();
        $dataProvider=NULL;
    ...
    /**
     * Displays printable version of summary Projectpermissions model.
     * @return mixed
     */
    ...
    /**
     * Displays PDF version of summary Projectpermissions model.
     * @return mixed
     */
    ...
    /**
     * Displays a single Projectpermissions model.
     * @param integer $id
     * @return mixed
     */
    public function actionView($id)
    {
        ...
        /**
     * Creates a new Projectpermissions model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Projectpermissions();
...
//            return $this->redirect(['index']);
    ...
    /**
     * Updates an existing Projectpermissions model.
    ...
    /**
     * Deletes an existing Projectpermissions model.
...
//            return "Failed to remove record";
    ...
    /**
     * Displays sidebar Projectpermissions model.
     * @return mixed
     */
    public function actionSidebarsummary()
    {
        $res = \app\models\Model::checksavedinfo(["r"=>"property/config/projectpermissions/index"]);
        
        $searchModel=$searchModel= new ProjectpermissionsSearch();
    ...
    /**
     * Finds the Projectpermissions model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Projectpermissions the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Projectpermissions::findOne($id)) !== null) {
            return $model;
        } else {
