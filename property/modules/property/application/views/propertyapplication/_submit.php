                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="widget-box widget-color-blue3" id="widget-box-7">
                            <div class="widget-header widget-header-small">
                                <h6 class="widget-title smaller">Submission</h6>
                            </div>

                            <div class="widget-body">
                                <div class="widget-main">
                                    <div class="form-group field-propertymemberships-approval_remarks">
                                        <?php
                                        echo $form->field($model, 'submission_remarks')->textarea()->label('Remarks');
                                        ?>
                                    </div>                                                    
                                </div>
                                <div class="widget-toolbox padding-8 clearfix">
                                    <button class="btn btn-xs btn-danger pull-left multiplesubmitbuttons" type="submit" name="submit" value="cancel">
                                        <i class="ace-icon fa fa-times"></i>
                                        <span class="bigger-110">Cancel</span>
                                    </button>

                                    <?php
                                    if($model->application_status == 10){
                                        
                                    } elseif($model->application_status == 1) {
?>
                                    <button class="btn btn-xs btn-warning pull-right multiplesubmitbuttons" type="submit" name="submit" value="submit">
                                        <i class="ace-icon fa fa-arrow-left icon-on-right"></i>
                                        <span class="bigger-110">Mark as New</span>
