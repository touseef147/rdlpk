...
/* @var $searchModel app\modules\security\models\SectargetscreensSearch */
...
?>
  ...
  <thead>
      ...
      <th class="HeaderMiddle" style="border-bottom:thin solid">Parent screen id      </th>
      <th class="HeaderMiddle" style="border-bottom:thin solid">Target screen id      </th>
...
<?php      foreach ($rows as $row) { ?>
      ...
      <td class="GridMiddleCell" align="right"><?php echo $row->parent_screen_id; ?>      </td>

                                                                  <td class="GridMiddleCell" align="right"><?php echo $row->target_screen_id; ?>      </td>
