...
<div class="secroles-form">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li >
                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=security/secroles/index" class="ajaxlink">Summary</a>
            </li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <?php
                        echo $form->field($model, 'role_type_id')
                                ->dropDownList(
                    ...
                    <div class="col-xs-4">
                        ...
                        <?php
                        echo $form->field($model, 'role_category_id')
                                ->dropDownList(
