...
<div class="fmsaccounts-form">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                    ...
                    <li >
                                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/accounts/index" class="ajaxlink">Summary</a>
                    </li>
    ...
    <div class="page-content">
            ...
            <div class="row">
                    <div class="col-xs-12">
                        <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/accounts/sidebarinput">
                        ...
                        <?php $form = ActiveForm::begin(['options'=>['class'=>'frminput']]); ?>
                            ...
                            <?= $form->field($model, 'category_id')->textInput() ?>
                                                ...
                                                <div class="row">
                            <div class="col-xs-12">
                            <?= $form->field($model, 'acc_code')->textInput(['maxlength' => true]) ?>
