...
<div class="fmstransmaster-search">
    ...
    'action' => Yii::$app->urlManager->baseUrl . "/index.php?r=finance/transmaster/index",
    'method' => 'GET',
    'class' => 'frmsearch',
    'id' => 'frmsearch',
    ]);
            ...
            <td>
                <table>
                    ...
                    ?>                    <tr>
                        ...
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/transmaster/create" class="ajaxlink">
                    ...
                    <?php                    }
                    if (array_key_exists("finance/transmaster/printsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/transmaster/printsummary" class="reportlink">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary
                            </a>
                        </td>
                    ...
                    <?php                    }
                    if (array_key_exists("finance/transmaster/pdfsummary", $myrights)) {
                    ?>                    <tr>
                        <td style="width:10px; height:30px;" class="sibar_links_content_left_col">&nbsp;
                        </td>
                        <td>
                            <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/transmaster/pdfsummary">
                                <i class="menu-icon fa fa-caret-right"></i>
                                Print Summary (pdf)
                            </a>
                        </td>
