                            ...
                            <div class="widget-box ui-sortable-handle" id="widget-box-1">
                                <div class="widget-header widget-header-large">
                                    ...
                                    <div class="widget-toolbar"> 
                                        <a class="add_dynamic_row" data-url="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/installmentplanmaster/dynamicrow" data-rowcount="drcount" data-desttable="dynamic_list" href="#">Add</a> 
                                    </div>
                                </div>
