...
$this->title = 'Instruments Verification';
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($rows as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td align="left">                            
                                                            <?php
                                                            if ($row->entry_status == 3) {
                                                                //if (array_key_exists("finance/fmsvoucher/centerverification", $myrights)) {
                                                                    ?>                                                                
                                                                    <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/financeverdetail&amp;id=<?php echo $row->voucher_id; ?>" class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                    <?php
                                                                //} else {
...
<!--                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/view&id=<?php echo $row->voucher_id; ?>" class="ajaxlink"><?php echo $row->showentrydate; ?></a>-->
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            if ($row->entry_status == 3) {
                                                                //if (array_key_exists("finance/fmsvoucher/centerverification", $myrights)) {
                                                                    ?>      
                                                                    <a data-original-title="Edit" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/financeverdetail&id=<?php echo $row->voucher_id; ?>" class="tooltip-error ajaxlink" data-rel="tooltip" title="">
                                                                        <span class="blue">
