                            ...
                            <div class="widget-box ui-sortable-handle" id="widget-box-1">
                                <div class="widget-header widget-header-large">
                                    ...
                                    <div class="widget-toolbar">
                                        ...
                                        <?php }
                                        ?>                                        
                                        <input type="hidden" id="search_nav_link" value="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/sidebarcenterversearch">
                                                        ...
                                                        <td align="left">                            
                                                            ...
                                                            if ($row->entry_status == 2) {
                                                                //if (array_key_exists("finance/fmsvoucher/centerverification", $myrights)) {
                                                                    ?>                                                                
                                                                    <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/centerverdetail&amp;id=<?php echo $row->voucher_id; ?>" class="ajaxlink"><?php echo $row->showentrydate; ?></a>
                                                                    <?php
                                                                //} else {
...
<!--                                                                <a href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/view&id=<?php echo $row->voucher_id; ?>" class="ajaxlink"><?php echo $row->showentrydate; ?></a>-->
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            if ($row->entry_status == 2) {
                                                                //if (array_key_exists("finance/fmsvoucher/centerverification", $myrights)) {
                                                                    ?>      
                                                                    <a data-original-title="Edit" href="<?php echo Yii::$app->urlManager->baseUrl; ?>/index.php?r=finance/fmsvoucher/centerverdetail&id=<?php echo $row->voucher_id; ?>" class="tooltip-error ajaxlink" data-rel="tooltip" title="">
                                                                        <span class="blue">
