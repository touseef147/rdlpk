...
<table style="width: 100%;">
    ...
    <tr>
        ...
        <td style="border-bottom: dotted"><?= $model->ms_no ?></td>
        ...
        <td style="border-bottom: dotted; width: 100px;"><?= $model->plot->sizeCat->size ?></td>
    ...
    <tr>
        ...
        <td colspan="3" style="border-bottom: dotted"><?= $model->plot->project->project_name ?></td>
