<div class=""> 
<div class="shadow">
  <h3>(Property Receipt) Add Receipt No.</h3>
</div>
...
<?php 
				...
				$val='';
				echo $r1  = "SELECT * FROM rpt_print where msid='".$new['plot_id']."' and rid='".$_REQUEST['id']."'";
				...
				if($sty!==''){echo '<button type="button" onclick="active('.$new['plot_id'].')" class="btn">Edit</button>
...
?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
                                'Update Receipt No.', array('/reciept/Gensubprop'),
                                array(  
