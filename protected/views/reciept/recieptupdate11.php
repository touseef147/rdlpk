...
echo '<div style="margin: 140px 0 0px 15px;position: absolute;">'.$data['type'].'</div>';
...
echo '<div style="margin: '.(390+$heg).'px 0 0px 100px;position: absolute; font-size:10px;"><b>User:</b>'.$result_us['salesname'].'&nbsp;|&nbsp;'.Yii::app()->session['user_array']['firstname'].'&nbsp;'.Yii::app()->session['user_array']['middelname'].'&nbsp;'.Yii::app()->session['user_array']['lastname'].'&nbsp;|&nbsp;'.date('d-M-Y h:m:s').'
...
echo '<div style="margin: '.(350+$heg).'px 0 0px 110px;position: absolute; font-family:segoepr;">'.$totalw.'</div>';
