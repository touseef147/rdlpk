...
$total=0;
$qury="select * from receipt where `fstatus` LIKE '%bounce%'";
$result=$connection->CreateCommand($qury)->queryAll();
$total=Count($result);?>
<div class="shadow">
...
<a href="monthly_report" class="btn" style="float:right;">Monthly Report</a> 
  <?php }?>
    <?php if(Yii::app()->session['user_array']['per19']==1){?>
        <a href="bouncerec_list" class="btn" style="float:right; ">Bounce Receipt<span style="color: red; font-weight: bold;">(<?php echo $total;?>)</span></a>
    <?php }?>
