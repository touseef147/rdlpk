...
<div class="new">
<a href="prop_alotment_lis"><div class="alert"><?php /* echo $transfer;*/ echo $property;  ?></div><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/property-icon.png"  width="150"  /><p>Property Allotment Requests</p></a></div>
