...
<body>
<div id="email" style="margin:80px 0 0 65px; position:absolute;">CNIC # : <?php echo $member['cnic']; 	 ?></div>
<div id="applicant_name" style="margin:390px 0 0 110px; position:absolute; font-size:14px;"> <?php if (empty( $member['image']))
          							  {
										 echo'<div style="height:100px;"></div>'; } else{    
										  echo'<img style="height:100px;"  src="'.Yii::getPathOfAlias('webroot').'/upload_pic/'.$member['image'].'"/>';
										 }
										  ?></div>
 <div id="applicant_name" style="margin:500px 0 0 220px; position:absolute; font-size:14px;"><?php echo $member['plotno']; 	 ?></div>
<div id="applicant_name" style="margin:500px 0 0 650px; position:absolute;"><?php echo date('d-m-Y');  	 ?></div>
<div id="email" style="margin:605px 0 0 150px; position:absolute; font-size:14px;"><?php echo $member['name']; 	 ?></div>

<div id="plotid" style="margin:605px 0 0 610px; position:absolute; font-size:14px;"><?php if($member['type']=='Plot'){  echo $member['plot_detail_address']; }else{ echo'...';} 	 ?>
</div>
<?php
...
<div id="plotid" style="margin:610px 0 0 625px; position:absolute; font-size:12px;">
<?php

 foreach($result_primeloc as $row){
 echo $row['title'].'<br />';?>
<?php }?>
</div>
...
<div id="email" style="margin:640px 0 0 210px; position:absolute; font-size:14px;"><?php echo $member['sodowo']; 	 ?></div>
<div id="email" style="margin:645px 0 0 545px; position:absolute; font-size:14px;"><?php echo $member['street']; 	 ?></div>
<div id="email" style="margin:672px 0 0 155px; position:absolute; width:250px; font-size:12px;"><?php echo $member['address']; 	 ?></div>
<div id="email" style="margin:680px 0 0 540px; position:absolute; font-size:14px;"><?php echo $member['sector_name']; 	 ?></div>
<div id="email" style="margin:710px 0 0 160px; position:absolute; font-size:14px;"><?php echo $member['phone']; 	 ?></div>
<div id="email" style="margin:710px 0 0 540px; position:absolute; font-size:14px;"><?php echo $member["size"]; 	 ?></div>
...
<body>
<div id="email" style="margin:120px 0 0 65px; position:absolute;">CNIC # : <?php echo $member['cnic']; 	 ?></div>
<div id="applicant_name" style="margin:390px 0 0 110px; position:absolute; font-size:14px;"> <?php if (empty( $member['image']))
          							  {
										 echo'<div style="height:100px;"></div>'; } else{    
										  echo'<img style="height:100px;"  src="'.Yii::getPathOfAlias('webroot').'/upload_pic/'.$member['image'].'"/>';
										  ...
										  ?></div>
 <div id="applicant_name" style="margin:520px 0 0 220px; position:absolute; font-size:14px;"><?php echo $member['plotno']; 	 ?></div>
<div id="applicant_name" style="margin:520px 0 0 630px; position:absolute;"><?php echo date('d-m-Y');  	 ?></div>
<div id="email" style="margin:615px 0 0 160px; position:absolute; font-size:14px;"><?php echo $member['name']; 	 ?></div>

<div id="plotid" style="margin:615px 0 0 600px; position:absolute; font-size:14px;"><?php if($member['type']=='Plot'){  echo $member['plot_detail_address']; }else{ echo'...';} 	 ?>
</div>
<?php
$connection = Yii::app()->db;
$sql_primeloc  = "SELECT *
...
<div id="email" style="margin:650px 0 0 210px; position:absolute; font-size:14px;"><?php echo $member['sodowo']; 	 ?></div>
<div id="email" style="margin:655px 0 0 545px; position:absolute; font-size:14px;"><?php echo $member['street']; 	 ?></div>
<div id="email" style="margin:672px 0 0 165px; position:absolute; width:250px; font-size:12px;"><?php echo $member['address']; 	 ?></div>
<div id="email" style="margin:680px 0 0 540px; position:absolute; font-size:14px;"><?php echo $member['sector_name']; 	 ?></div>
<div id="email" style="margin:710px 0 0 160px; position:absolute; font-size:14px;"><?php echo $member['phone']; 	 ?></div>
<div id="email" style="margin:710px 0 0 540px; position:absolute; font-size:14px;"><?php echo $member['plot_size'];	 ?></div>
 <?php $connection = Yii::app()->db;
$sql_assoc  = "SELECT *
FROM members
LEFT JOIN associates ON ( associates.mid = members.id )
...
<div id="email" style="margin:615px 0 0 560px; position:absolute;"><?php echo $member["size"]." (".$member['plot_size'].")"; 	 ?></div>
...
<div id="email" style="margin:605px 0 0 480px; position:absolute;"><?php echo $member['plot_size'];	?></div>
