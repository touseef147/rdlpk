...
<div class="shadow">
  ...
  <?php if((Yii::app()->session['user_array']['per33']=='1')&& isset(Yii::app()->session['user_array']['username'])){ ?><h5 style="float:right"> <a href="cancelled_files">Cancelled Files</a></h5><?php }?>
