      ...
      <div class="modal-body">
       ...
       $sql_payment  = "SELECT * FROM projects";
		$result_payments = $connection->createCommand($sql_payment)->queryAll();
		 $sql_payment1  = "SELECT property.*,projects.id as pid FROM property
		left join plots on property.plot_id=plots.id
		left join projects on plots.project_id=projects.id
		where property.status='New' and property.fstatus='approved' and property.fcomment!=''";
...
?>
 ...
 <?php echo CHtml::ajaxSubmitButton(
    ...
    array('/memberplot/Propalotmentreq'),
