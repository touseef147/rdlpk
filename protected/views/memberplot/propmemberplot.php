...
<input type="number" style=" font-weight:bold; font-size:15;width:150px; height:25px; background-color:#0CF;" class="reg-login-text-field" id="appnoo" name="appnoo" value="">
     ...
     <label style="float:left;"><input type="radio" id="pptype" name="pptype" value="Res" class="new1" style="float:left;"  onclick="document.getElementById('project').disabled = false;" />Residential  </label>  
     <label style="float:left;"><input type="radio" id="pptype"  name="pptype" value="Com"  class="new1" style="float:left;" onclick="document.getElementById('project').disabled = false;"/>Commercial</label>
    </div>
