...
$st=$st+1;
   ...
   <div style="padding-left:5%;" class="carousel-inner">
      ...
      <?php 
        ...
        <?php if(!empty($slid['link'])){?><a href="<?php echo 'http://'. $slid['link'];?>"><div class="active item"><img width="95%" src="<?php echo Yii::app()->request->baseUrl.'/images/slider/'.$slid['image'];?>"></a>
