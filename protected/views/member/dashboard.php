...
<tr>
<td>'.$var['plotno'].'</td>
<td>';if($var['ststf']==2){ echo'<span style="color:red">Blocked</span>';}else{ echo $key1['plot_detail_address'];}echo'</td>
<td>'.$var['size'].'</td>
<td>'.$var['plot_size'].'</td><td>';echo'</td>
<td>';if($var['ststf']==2){ echo'<span style="color:red">Blocked</span>';}else{ echo $key1['street'];}echo'</td>
<td>';if($var['ststf']==2){ echo'<span style="color:red">Blocked</span>';}else{ echo $key1['sector_name'];}echo'</td>
<td>'.$key1['project_name'].'</td>
<td>'.$var['project_name'].'</td>
<td><a href=" '.Yii::app()->request->baseUrl.'/index.php/member/plothistory?id='.$var['plot_id'].'">History</a></td><td>';if($key1['stst']==2){ echo'<span style="color:red">Blocked</span>';}else{
	 echo '<a href=" '.Yii::app()->request->baseUrl.'/index.php/member/transferplot?plot_id='.$key1['plot_id'].'">Transfer</a></td>';}
echo'<td><a href=" '.Yii::app()->request->baseUrl.'/index.php/member/transferplot?plot_id='.$var['plot_id'].'">Transfer</a></td>
