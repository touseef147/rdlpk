...
<script>	
 $(function(){
	  ...
	  var stat=2;	
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/memberplotsales/transferreq",
                  type:"POST",
...
<?php if(empty($html)){ echo'';}else{?><script type="text/javascript"> $(function(){
setTimeout(function() {
    $('#myElem').fadeOut('fast');
}, 5000); // <-- time in milliseconds

});</script> </section><?php echo $html;}?>
