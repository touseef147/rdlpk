<div class="shadow">
  <h3>Property Allotment Request Details</h3>
</div>
<!-- shadow -->
...
<?php //}?>
  ...
  <div class="span4" style="background-color: rgba(91, 192, 222, 0.54);
    padding: 10px;
    float:right;
    border: 1px solid #000;
    border-radius: 15px;">
  <div class="bot-box" >
    <label> <a href="cancelallot" class="btn" style="float:right"> Cancel(Remove Request)</a>
 ...
 'enableAjaxValidation'=>false,
  'enableClientValidation'=>true,
    ...
    <label>New MS #</label>
        <input name="plot_id" id="plot_id" type="hidden" value="<?php echo $_GET['plot_id'] ?>" />
    ...
    <input type="text" value="<?php  echo $key['scode']; ?>" name="sizecode" id="sizecode" class="reg-login-text-field" style="width:60px;" readonly/>
    <?php echo CHtml::ajaxSubmitButton('Submit For Approvel',array('Submitprop'), array( 'beforeSend' => 'function(){ 
...
?>
 ...
 <?php echo $key['plot_detail_address'] ?></td></tr>
      ...
      <tr><td> Block/Sector:</td><td>
       <?php echo $key['buildname']?></td></tr>
      <tr><td> Plot category:</td><td>
       <?php echo $key['fname']?></td></tr>
  ...
  <?php 
	$connection = Yii::app()->db; 	
$sql_details2  = "SELECT * FROM property where id=".$_REQUEST['plot_id']."";
...
$new_date = date('d-m-Y', $middle); 
 ...
 <h5><a href="<?php echo $home?>/memberplotsales/prop_payment_details?id=<?php echo $_REQUEST['plot_id']; ?>&&pid=">Payment Details</a></h5>
    <table class="table table-striped table-new table-bordered">
 <tbody>
 <tr>
 <td>Cost Of Plot:</td>
 ...
 <td>Installment:</td>
 <?php 
 $sql_details12  = "SELECT * FROM proinstallpayment where plot_id=".$_REQUEST['plot_id']."";
$result_details12 = $connection->createCommand($sql_details12)->queryAll();
 ...
 <tr>
 <td><h5 style="text-align:left;">Request Details:</h5></td><td></td></tr>
 <tr>
 <td>Request Date:</td>
 ...
 <tr>
 <td><h5 style="text-align:left;">Finance User Status:</h5></td>
