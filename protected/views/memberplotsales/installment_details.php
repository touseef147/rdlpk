...
?> 
 ...
 <th style="border-right:none;border-left:none; float:right;" width="50%"><a href="location_charges?id=<?php echo $_REQUEST['id']?>"><input type="button" value="Add Location Charges" class="btn btn-info btn-xs view_data"></a></th>
 <tbody>
