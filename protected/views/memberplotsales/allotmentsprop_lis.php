...
<script>	
 $(function(){
	  var project_name=$("#project_name").val();
	   var stat=2;	
 $.ajax({
	     url:"http://<?php echo $address ?>/index.php/memberplotsales/searchreqprop",
                  type:"POST",
...
<a href="memberplot" class="btn" style="float:right">New Property Allotment</a>

  <h3>Property Allotment List</h3></div>
...
<option value="1">Submitted</option>
 ...
 <?php echo CHtml::ajaxSubmitButton(
     ...
     array('memberplotsales/searchreqprop/?page=1'),
            ...
            <table class="table table-striped table-new table-bordered" style="font-size:12px;">
            	...
            	<thead style="background:#666; border-color:#ccc; color:#fff;">
                    ...
                    <tr>
                        ...
                        <th width="6%">CNIC</th>
  						 <th width="6%">Property Size</th>
                        <th width="3%">Property No.</th>

                        <th width="6%">Building</th>
