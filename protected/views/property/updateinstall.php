<div class="shadow">
  <h3>Update Installment Plan (Property)</h3>
</div>
<!-- shadow -->
...
?>
  ...
  <select style="width:210px;" name="project_id" id="project">
  ...
  <select style="width:150px;" name="category_id" id="category_id">
 ...
 <div class="float-left">
    ...
    <p class="reg-right-field-area margin-left-5">
     <input style="width:190px;" type="text" value="<?php echo $key['description'];?>" name="description" id="description" class="reg-login-text-field" />
    </p>
  </div>
  <div class="float-left">
    ...
    <p class="reg-right-field-area margin-left-5">
      ...
      <input style="width:150px;" type="text" value="<?php echo $key['tno'];?>" name="tno" id="tno" class="reg-login-text-field" />
