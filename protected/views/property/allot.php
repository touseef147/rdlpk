...
<b>Building Name.</b><?php echo $key['bname'];?><br />
<b>Floor #.</b><?php echo $key['fname'];?><br />
  ...
  <p class="reg-left-text">CNIC<font color="#FF0000">*</font></p>
    <p class="reg-right-field-area margin-left-5">
      <input type="text" value="" name="cnic" id="cnic" class="reg-login-text-field" />
        <input type="hidden" value="<?php echo $_GET['id'];?>" name="id" id="id" class="reg-login-text-field" />
    </p>
  </div>
<div class="float-left">
