...
<span>Sector:</span>
 ...
 <span>Type:</span>
      <select style="width:180px;" id="com_res" name="com_res"><option value="">Select Property Type</option><option value="Res">Residential</option><option value="Com">Commercial</option></select>       
