...
$sql_bnk  = "SELECT * FROM bank";
			$resbnk = $connection->createCommand($sql_bnk)->queryAll();
			$banks=count ($resbnk);?>
...
<span style="color:#093; font-weight:bold;">(<?php echo $banks;?>)</span>
</div>
...
<h6>User</h6>
</a><span style="color:#093; font-weight:bold";>(<?php echo $users;?>)</span>
</div>
<?php } ?>
...
<a href="<?php echo $this->createAbsoluteUrl('property/buildings_list')?>">

<img width="50px" src="<?php echo Yii::app()->request->baseUrl; ?>/images/building-icon.png" />
...
<a href="<?php echo $this->createAbsoluteUrl('property/floors_list')?>">

<img width="50px" src="<?php echo Yii::app()->request->baseUrl; ?>/images/floor-icon.png" />
...
<a href="<?php echo $this->createAbsoluteUrl('property/assignproperty')?>">

<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/property.png" />
...
<h6 style=" text-align:center;">Property Size Categories</h6></a></div> 
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/property-icon.png" />
...
<a href="<?php echo $this->createAbsoluteUrl('property/insplanlist')?>">
...
<div class="span3" style="padding:5px 25px;"><a href="<?php echo $this->createAbsoluteUrl('memberplot/prop_alotment_lis')?>" ><span style=" color:#FFFFFF; background-color: #FF0000;border-radius: 3px;padding: 3px 5px;vertical-align: super;"><?php echo $count; ?></span><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/property-icon.png" />
...
<div class="span3" style="padding:5px 25px;"><a href="<?php echo $this->createAbsoluteUrl('member/RFM')?>" ><span style=" color:#FFFFFF; background-color: #FF0000;border-radius: 3px;padding: 3px 5px;vertical-align: super;"><?php echo $count1; ?></span><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/member-request.png" />
...
<h6 style=" text-align:center;">Member Transfer Request</h6></a></div> <?php }?>
        ...
        <?php }?>    <h6 style=" text-align:center;">Member Message</h6></a></div> 
			  <?php  } if(Yii::app()->session['user_array']['per8']=='1'){
            $connection = Yii::app()->db;
...
$pos=$pos+1;
	...
	Left JOIN floors  ON (mp.floor_id = floors.id)
	 where mp.fstatus='Sales'";
		 $result_sales = $connection->createCommand($sqlsales)->query();	
			 echo count($result_sales);?></span>

                        <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/property-allot-icon.png" />

            <h6 style=" text-align:center;">Property Allotments</h6></a></div>
		...
		?>
           ...
           <span style=" background-color: #FF0000; color:#FFFFFF;border-radius: 3px;padding: 3px 5px;vertical-align: super;">
            ...
            <h6 style=" text-align:center;">Cancellation List</h6></a></div>
            <?php }?>
