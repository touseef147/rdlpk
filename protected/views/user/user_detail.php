...
<div class="" style="">
 ...
 <br>
  	<div class="black-bg">My Password:</div><div class="grey-bg"><?php echo base64_decode($key['password']);?></div>
...
<div class="black-bg">Email:</div><div class="grey-bg"><?php echo $key['email'];?></div>
  ...
  <div class="black-bg">Change Password:</div><input  style="height:23px;" value="<?php echo base64_decode($key['password']);?>"  type="text" name="password" id="password" />
