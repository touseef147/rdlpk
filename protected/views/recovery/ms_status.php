...
<table class="table table-striped table-new table-bordered" style="font-size:13px; font-weight:bold;">
             ...
             <?php 
			 $connection = Yii::app()->db;
 $mshistory  = "SELECT sh.status,sh.user_id,u.username,sh.detail,sh.status_date,mp.plotno,mp.plot_id,mp.app_no,sh.type,mp.mstatus,p.plot_detail_address,p.plot_size,p.image
