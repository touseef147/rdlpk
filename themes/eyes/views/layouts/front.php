...
$conn = mysqli_connect("localhost","root","","rdlpk_db1");
	         ...
	         //  $conn = mysql_connect('localhost','rdlpk','') or die(mysql_error());
		...
		///	$select_db = mysql_select_db('rdlpk_db1',$conn) or die(mysql_error());
				...
				$result=mysqli_query($conn,"select * from menu where sub_level=0 and status=1");
				///$result = mysql_query($sql) or die(mysql_error());
					

				//$row=mysqli_fetch_array($result,MYSQLI_ASSOC);

				while($menu_item =mysqli_fetch_array($result,MYSQLI_ASSOC)){
...
<li> <a href="'.$this->CreateAbsoluteUrl("web/project_details?id=".$key2['id']."").'">'.$key2['project_name'].'</a></li>';
    ...
    <div class="col-lg-3">
      ...
      <div class="g-recaptcha" data-sitekey="6LeV2poUAAAAACGGh0Mt60iJeAZ3de8hQw9j2pWa"></div>
        <br>
