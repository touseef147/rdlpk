...
<div class="container-fluid"> 
 ...
 <li><a href="<?php echo $this->createAbsoluteUrl('plots/plots')?>" class="link-2" title="Plot">Plot</a></li>
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('charges/charges')?>" class="link-2" title="Charges">Charges</a></li>
             <li><a href="<?php echo $this->createAbsoluteUrl('property/property')?>" class="link-2" title="Charges">Property</a></li>
            <?php }?>
   ...
   <?php if(Yii::app()->session['user_array']['per12']=='1'
        ...
        <li><a href="#" class="link-2" title="Search">Sales</a>
          ...
          <?php if(Yii::app()->session['user_array']['per18']=='1' or Yii::app()->session['user_array']['per19']=='1' or Yii::app()->session['user_array']['per20']=='1' or Yii::app()->session['user_array']['per21']=='1'){  ?>
            <li><a href="<?php echo $this->createAbsoluteUrl('reciept/reciept_lis')?>" class="link-2" title="Instrument List">Payments</a></li>
             <li><a href="<?php echo $this->createAbsoluteUrl('reciept/propintrument_list')?>" class="link-2" title="Property Instrument">Property Payments</a></li>
          <?php }
		  if(Yii::app()->session['user_array']['per19']=='1' or Yii::app()->session['user_array']['per21']=='1'){?>  
		   ...
		   if(Yii::app()->session['user_array']['per12']=='1'){  ?>
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplotsales/allotments_lis')?>" class="link-2" title="File">Allotments</a></li>
              <li><a href="<?php echo $this->createAbsoluteUrl('memberplotsales/propmemberplot')?>" class="link-2" title="File">Allot Property</a></li>
          <?php }?>
    ...
    <?php if(Yii::app()->session['user_array']['per2']=='1'){  ?>
           <li><a href="<?php echo $this->createAbsoluteUrl('allotments/reslist?pid=1')?>" class="link-2" title="Plot">Search Balloting</a></li>
            ...
            <li><a href="<?php echo $this->createAbsoluteUrl('files/files_lis')?>" class="link-2" title="File">File</a></li><?php }elseif(Yii::app()->session['user_array']['per34']=='1'){ ?>
             <li><a href="<?php echo $this->createAbsoluteUrl('memberplot/member_flis')?>" class="link-2" title="Member File">Member File</a></li>
            <li><a href="<?php echo $this->createAbsoluteUrl('memberplot/member_lis')?>" class="link-2" title="Member Plot">Member Plot</a></li>
            <li><a href="<?php echo $this->createAbsoluteUrl('plots/plots_lis')?>" class="link-2" title="Plots">Plots</a></li>
